...
from utils import MAX_YEARS, MIN_AMOUNT_TOLERABLE, INFLATION_ON, MONTHLY_MIN, MONTHLY_MAX, TAX, MODELS, DEFAULT_MODEL
...
with col2:
    ...
    tax_rate = st.number_input('Tax Rate', min_value=0.0, max_value=1.0, value=TAX)
...
if st.button('Click to run'):
    ...
    run_model(MODELS[stock], years,min_tol,tax_rate,month_min, month_max, inflation, data_load_state)
